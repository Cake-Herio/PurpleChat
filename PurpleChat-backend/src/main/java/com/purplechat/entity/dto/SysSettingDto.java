...
public class SysSettingDto implements Serializable {
    ...
    private static final long serialVersionUID = -405270100235714L; //
    private Integer maxImageSize = 2; //0
    private Integer maxVideoSize = 5; //1
    private Integer maxFileSize = 500; //2
    private Integer maxGroupCount = 50;
    private Integer maxGroupMemberCount = 500;

    private String robotUid = Constants.ROBOT_UID;
    private String robotNickName = "PurpleChat";
    private String robotWelcome = "欢迎来到文老师的PurpleChat";
